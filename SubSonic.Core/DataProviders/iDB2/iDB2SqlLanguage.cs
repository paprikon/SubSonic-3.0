...
{
    /// <summary>
    /// iDB2 specific QueryLanguage
    /// </summary>

    public class iDB2Language : QueryLanguage
    {
        public iDB2Language(IDataProvider provider)
            : base(provider)
        {
        ...
        {
            return iDB2Formatter.FormatExpression(expression);
        }
